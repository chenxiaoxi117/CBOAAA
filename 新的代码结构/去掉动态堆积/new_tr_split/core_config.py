...
class ExperimentConfig:
    ...
    SCENARIO_WINDOW = 240.0  # 统计情景指标时看的滑动时间窗长度；与 BO_INTERVAL 对齐
    ...
    WINDOW_BACKLOG_GROWTH_WEIGHT = 0.0
    ...
    # Shared normalization reference policy.
    # cbo_first: the selected CBO method runs within the normal BO budget,
    # uses the first few windows to build the reference, then BO/other methods
    # reuse that CBO-derived reference scale.
    # fixed_probe: legacy neutral fixed-policy probe before method runs.
    ...
    CBO_SHARED_REFERENCE_ACTIVE_SOURCE_KEY = ""
    ...
    DEFAULT_CBO_CONTEXT_MIN_ROWS = 40
    DEFAULT_CBO_CONTEXT_RECENT_KEEP = 20
    DEFAULT_CBO_CONTEXT_WEAK_FALLBACK_K = 40
    DEFAULT_CBO_GLOBAL_CONTEXT_SIM_THRESHOLD = 0.70
    DEFAULT_CBO_EXTERNAL_INTERNAL_SIM_THRESHOLD = 0.75
    ...
    DEFAULT_CBO_ADAPTIVE_EXPLORATION_BETA_MAX = 3.0
    DEFAULT_CBO_ADAPTIVE_EXPLORATION_ETA_MAX = 0.25
    DEFAULT_CBO_ADAPTIVE_EXPLORATION_WINDOW = 30
    DEFAULT_CBO_ADAPTIVE_EXPLORATION_SAMPLE_TARGET = 80
    DEFAULT_CBO_ADAPTIVE_EXPLORATION_SMOOTHING = 0.20
    DEFAULT_CBO_ADAPTIVE_EXPLORATION_PROGRESS_PCT = 0.01
    DEFAULT_CBO_ADAPTIVE_EXPLORATION_REEXPLORE_GAIN = 0.25
    DEFAULT_CBO_ADAPTIVE_EXPLORATION_PLAUSIBLE_MARGIN_MULT = 2.0
    DEFAULT_CBO_ADAPTIVE_EXPLORATION_BACKLOG_REF = 1.0
    DEFAULT_CBO_ADAPTIVE_EXPLORATION_UNFINISHED_REF = 0.10
    DEFAULT_CBO_ADAPTIVE_EXPLORATION_TREND_REF = 0.05
    DEFAULT_CBO_ADAPTIVE_EXPLORATION_MAX_UTIL_START = 0.80
