...
def build_scenario_method_groups():
    ...
    return {
        ...
        "reduced7_bo_adaptive": {
            "label": "Reduced7 BO-Adaptive Exploration Global Energy",
            "norm_mode": "fixed",
            "control_mode": "reduced7",
            "deploy_policy": "greedy",
        ...
        "reduced7_cbo_lite_internal4": {
            "label": "Reduced7 CBO-Lite ExternalTaskMix+Internal4 Global Energy",
            "norm_mode": "fixed",
            "control_mode": "reduced7",
            "deploy_policy": "greedy",
            "method_family": "reduced7_global_energy_cbo",
        ...
        "reduced7_cbo_lite_internal6_context": {
            "label": "Reduced7 CBO-Lite ExternalTaskMix+Internal6 ContextHistory Global Energy",
            "norm_mode": "fixed",
            "control_mode": "reduced7",
            "deploy_policy": "greedy",
            "method_family": "reduced7_global_energy_cbo",
            ...
            "history_mode": "recent",
            "recent_window": 80,
            "cbo_history_select_mode": "recent_context",
            "cbo_context_k": 50,
            "cbo_context_sim_threshold": 0.0,
            "cbo_external_gate_mode": "taskmix_intensity",
            "cbo_external_gate_threshold": 0.35,
            "cbo_external_gate_topk": 240,
            "cbo_external_gate_min_samples": 12,
        ...
        "reduced7_cbo_lite_internal4_context": {
            "label": "Reduced7 CBO-Lite ExternalTaskMix+Internal4 ContextHistory Global Energy",
            "norm_mode": "fixed",
            "control_mode": "reduced7",
            "deploy_policy": "greedy",
            "method_family": "reduced7_global_energy_cbo",
...
def _write_refactor_config_snapshot(output_dir, selected_keys=None, groups=None):
    ...
    try:
        ...
        payload = {
            ...
            "cbo_context_min_rows": int(getattr(CFG, "CBO_CONTEXT_MIN_ROWS", 40)),
            "cbo_context_recent_keep": int(getattr(CFG, "CBO_CONTEXT_RECENT_KEEP", 20)),
            "cbo_context_weak_fallback_k": int(getattr(CFG, "CBO_CONTEXT_WEAK_FALLBACK_K", 40)),
            "cbo_global_context_sim_threshold": float(getattr(CFG, "CBO_GLOBAL_CONTEXT_SIM_THRESHOLD", 0.70)),
            "cbo_external_internal_sim_threshold": float(getattr(CFG, "CBO_EXTERNAL_INTERNAL_SIM_THRESHOLD", 0.75)),
            "cbo_external_internal_topk": int(getattr(CFG, "CBO_EXTERNAL_INTERNAL_TOPK", 400)),
            "cbo_external_internal_min_rows": int(getattr(CFG, "CBO_EXTERNAL_INTERNAL_MIN_ROWS", 40)),
            "cbo_external_internal_recent_keep": int(getattr(CFG, "CBO_EXTERNAL_INTERNAL_RECENT_KEEP", 20)),
            ...
            "cbo_sigma_calibration_use_in_acq": str(getattr(CFG, "CBO_SIGMA_CALIBRATION_USE_IN_ACQ", "false")),
            "cbo_adaptive_exploration_beta_max": float(getattr(CFG, "CBO_ADAPTIVE_EXPLORATION_BETA_MAX", 3.0)),
            "cbo_adaptive_exploration_eta_max": float(getattr(CFG, "CBO_ADAPTIVE_EXPLORATION_ETA_MAX", 0.25)),
            "cbo_adaptive_exploration_window": int(getattr(CFG, "CBO_ADAPTIVE_EXPLORATION_WINDOW", 30)),
            "cbo_adaptive_exploration_sample_target": int(getattr(CFG, "CBO_ADAPTIVE_EXPLORATION_SAMPLE_TARGET", 80)),
            "cbo_adaptive_exploration_smoothing": float(getattr(CFG, "CBO_ADAPTIVE_EXPLORATION_SMOOTHING", 0.20)),
            "cbo_adaptive_exploration_progress_pct": float(getattr(CFG, "CBO_ADAPTIVE_EXPLORATION_PROGRESS_PCT", 0.01)),
            "cbo_adaptive_exploration_reexplore_gain": float(getattr(CFG, "CBO_ADAPTIVE_EXPLORATION_REEXPLORE_GAIN", 0.25)),
            "cbo_adaptive_exploration_plausible_margin_mult": float(getattr(CFG, "CBO_ADAPTIVE_EXPLORATION_PLAUSIBLE_MARGIN_MULT", 2.0)),
            "cbo_adaptive_exploration_backlog_ref": float(getattr(CFG, "CBO_ADAPTIVE_EXPLORATION_BACKLOG_REF", 1.0)),
            "cbo_adaptive_exploration_unfinished_ref": float(getattr(CFG, "CBO_ADAPTIVE_EXPLORATION_UNFINISHED_REF", 0.10)),
            "cbo_adaptive_exploration_trend_ref": float(getattr(CFG, "CBO_ADAPTIVE_EXPLORATION_TREND_REF", 0.05)),
            "cbo_adaptive_exploration_max_util_start": float(getattr(CFG, "CBO_ADAPTIVE_EXPLORATION_MAX_UTIL_START", 0.80)),
