...
def group_log_to_dataframe(log, group_key, group_label):
    ...
    for i in range(n):
        ...
        row = {
            ...
            "external_internal_threshold_enabled": _log_get_ffill(log, "external_internal_threshold_enabled", i, None),
            "external_internal_external_threshold": _log_get_ffill(log, "external_internal_external_threshold", i, None),
            "external_internal_internal_threshold": _log_get_ffill(log, "external_internal_internal_threshold", i, None),
            "external_internal_external_topk": _log_get_ffill(log, "external_internal_external_topk", i, None),
            "external_internal_context_k": _log_get_ffill(log, "external_internal_context_k", i, None),
            "external_internal_min_rows": _log_get_ffill(log, "external_internal_min_rows", i, None),
            "external_internal_external_min_rows": _log_get_ffill(log, "external_internal_external_min_rows", i, None),
            "external_internal_recent_keep": _log_get_ffill(log, "external_internal_recent_keep", i, None),
            "external_internal_weak_fallback_k": _log_get_ffill(log, "external_internal_weak_fallback_k", i, None),
            "external_internal_raw_records": _log_get_ffill(log, "external_internal_raw_records", i, None),
            "external_internal_external_passed_count": _log_get_ffill(log, "external_internal_external_passed_count", i, None),
            "external_internal_external_pool_count": _log_get_ffill(log, "external_internal_external_pool_count", i, None),
            "external_internal_internal_scored_count": _log_get_ffill(log, "external_internal_internal_scored_count", i, None),
            "external_internal_internal_strong_count": _log_get_ffill(log, "external_internal_internal_strong_count", i, None),
            "external_internal_internal_weak_count": _log_get_ffill(log, "external_internal_internal_weak_count", i, None),
            "external_internal_selected_strong_count": _log_get_ffill(log, "external_internal_selected_strong_count", i, None),
            "external_internal_selected_weak_count": _log_get_ffill(log, "external_internal_selected_weak_count", i, None),
            "external_internal_selected_recent_count": _log_get_ffill(log, "external_internal_selected_recent_count", i, None),
            "external_internal_final_fallback_count": _log_get_ffill(log, "external_internal_final_fallback_count", i, None),
            "external_internal_fallback_used": _log_get_ffill(log, "external_internal_fallback_used", i, None),
            "external_internal_external_fallback_used": _log_get_ffill(log, "external_internal_external_fallback_used", i, None),
            "external_internal_external_fallback_reason": _log_get_ffill(log, "external_internal_external_fallback_reason", i, None),
            "external_internal_external_similarity_max": _log_get_ffill(log, "external_internal_external_similarity_max", i, None),
            "external_internal_external_similarity_mean": _log_get_ffill(log, "external_internal_external_similarity_mean", i, None),
            "external_internal_external_similarity_p50": _log_get_ffill(log, "external_internal_external_similarity_p50", i, None),
            "external_internal_external_pool_similarity_mean": _log_get_ffill(log, "external_internal_external_pool_similarity_mean", i, None),
            "external_internal_external_pool_similarity_min": _log_get_ffill(log, "external_internal_external_pool_similarity_min", i, None),
            "external_internal_internal_similarity_max": _log_get_ffill(log, "external_internal_internal_similarity_max", i, None),
            "external_internal_internal_similarity_mean": _log_get_ffill(log, "external_internal_internal_similarity_mean", i, None),
            "external_internal_internal_similarity_p50": _log_get_ffill(log, "external_internal_internal_similarity_p50", i, None),
            "external_internal_selected_external_similarity_mean": _log_get_ffill(log, "external_internal_selected_external_similarity_mean", i, None),
            "external_internal_selected_external_similarity_min": _log_get_ffill(log, "external_internal_selected_external_similarity_min", i, None),
            "external_internal_selected_internal_similarity_mean": _log_get_ffill(log, "external_internal_selected_internal_similarity_mean", i, None),
            "external_internal_selected_internal_similarity_min": _log_get_ffill(log, "external_internal_selected_internal_similarity_min", i, None),
            "external_internal_selected_phase_counts": _log_get_ffill(log, "external_internal_selected_phase_counts", i, None),
            "decay_history_target_rows": _log_get_ffill(log, "decay_history_target_rows", i, None),
            "decay_history_current_phase_id": _log_get_ffill(log, "decay_history_current_phase_id", i, None),
            "decay_history_current_phase_name": _log_get_ffill(log, "decay_history_current_phase_name", i, None),
            "decay_history_current_available_count": _log_get_ffill(log, "decay_history_current_available_count", i, None),
            "decay_history_current_selected_count": _log_get_ffill(log, "decay_history_current_selected_count", i, None),
            "decay_history_similar_budget": _log_get_ffill(log, "decay_history_similar_budget", i, None),
            "decay_history_similar_selected_count": _log_get_ffill(log, "decay_history_similar_selected_count", i, None),
            "decay_history_global_selected_count": _log_get_ffill(log, "decay_history_global_selected_count", i, None),
            "decay_history_similar_keep": _log_get_ffill(log, "decay_history_similar_keep", i, None),
            "decay_history_global_keep": _log_get_ffill(log, "decay_history_global_keep", i, None),
            "decay_history_global_max": _log_get_ffill(log, "decay_history_global_max", i, None),
            "decay_history_external_intensity_max_diff": _log_get_ffill(log, "decay_history_external_intensity_max_diff", i, None),
            "decay_history_intensity_rejected_count": _log_get_ffill(log, "decay_history_intensity_rejected_count", i, None),
            "phase_reuse_relation": _log_get_ffill(log, "phase_reuse_relation", i, None),
            "phase_reuse_current_bo_iter": _log_get_ffill(log, "phase_reuse_current_bo_iter", i, None),
            "phase_reuse_current_phase_id": _log_get_ffill(log, "phase_reuse_current_phase_id", i, None),
            "phase_reuse_current_phase_name": _log_get_ffill(log, "phase_reuse_current_phase_name", i, None),
            "phase_reuse_target_rows": _log_get_ffill(log, "phase_reuse_target_rows", i, None),
            "phase_reuse_memory_keep": _log_get_ffill(log, "phase_reuse_memory_keep", i, None),
            "phase_reuse_current_available_count": _log_get_ffill(log, "phase_reuse_current_available_count", i, None),
            "phase_reuse_current_selected_count": _log_get_ffill(log, "phase_reuse_current_selected_count", i, None),
            "phase_reuse_history_budget": _log_get_ffill(log, "phase_reuse_history_budget", i, None),
            "phase_reuse_exact_available_count": _log_get_ffill(log, "phase_reuse_exact_available_count", i, None),
            "phase_reuse_partial_available_count": _log_get_ffill(log, "phase_reuse_partial_available_count", i, None),
            "phase_reuse_exact_selected_count": _log_get_ffill(log, "phase_reuse_exact_selected_count", i, None),
            "phase_reuse_partial_selected_count": _log_get_ffill(log, "phase_reuse_partial_selected_count", i, None),
            "phase_reuse_global_selected_count": _log_get_ffill(log, "phase_reuse_global_selected_count", i, None),
            "phase_reuse_total_selected_count": _log_get_ffill(log, "phase_reuse_total_selected_count", i, None),
            "phase_reuse_component_threshold": _log_get_ffill(log, "phase_reuse_component_threshold", i, None),
            "phase_reuse_taskmix_min_sim": _log_get_ffill(log, "phase_reuse_taskmix_min_sim", i, None),
            "phase_reuse_overall_sim_threshold": _log_get_ffill(log, "phase_reuse_overall_sim_threshold", i, None),
            "phase_reuse_taskmix_weight": _log_get_ffill(log, "phase_reuse_taskmix_weight", i, None),
            "phase_reuse_similar_initial_cap": _log_get_ffill(log, "phase_reuse_similar_initial_cap", i, None),
            "phase_reuse_similar_decay_end": _log_get_ffill(log, "phase_reuse_similar_decay_end", i, None),
            "phase_reuse_intensity_only_rejected_count": _log_get_ffill(log, "phase_reuse_intensity_only_rejected_count", i, None),
            "phase_reuse_taskmix_gate_rejected_count": _log_get_ffill(log, "phase_reuse_taskmix_gate_rejected_count", i, None),
            "phase_reuse_overall_similarity_mean": _log_get_ffill(log, "phase_reuse_overall_similarity_mean", i, None),
            "phase_reuse_overall_similarity_max": _log_get_ffill(log, "phase_reuse_overall_similarity_max", i, None),
            "phase_reuse_archive_scene_count": _log_get_ffill(log, "phase_reuse_archive_scene_count", i, None),
            "phase_reuse_archive_rows_total": _log_get_ffill(log, "phase_reuse_archive_rows_total", i, None),
            "phase_reuse_policy": _log_get_ffill(log, "phase_reuse_policy", i, None),
            "phase_reuse_external_signature_source": _log_get_ffill(log, "phase_reuse_external_signature_source", i, None),
            "phase_reuse_target_reference_ready": _log_get_ffill(log, "phase_reuse_target_reference_ready", i, None),
            "phase_reuse_reference_aligned_labels": _log_get_ffill(log, "phase_reuse_reference_aligned_labels", i, None),
            "phase_reuse_novel_global_fallback_enabled": _log_get_ffill(log, "phase_reuse_novel_global_fallback_enabled", i, None),
            "phase_reuse_unrelated_global_fallback_enabled": _log_get_ffill(log, "phase_reuse_unrelated_global_fallback_enabled", i, None),
            "phase_reuse_similar_fill_target_enabled": _log_get_ffill(log, "phase_reuse_similar_fill_target_enabled", i, None),
            "phase_reuse_exact_use_similar_fallback": _log_get_ffill(log, "phase_reuse_exact_use_similar_fallback", i, None),
            "phase_reuse_internal_hard_gate_enabled": _log_get_ffill(log, "phase_reuse_internal_hard_gate_enabled", i, None),
            "phase_reuse_internal_hard_gate_threshold": _log_get_ffill(log, "phase_reuse_internal_hard_gate_threshold", i, None),
            "phase_reuse_internal_hard_gate_rejected_count": _log_get_ffill(log, "phase_reuse_internal_hard_gate_rejected_count", i, None),
            "phase_reuse_similar_training_target_enabled": _log_get_ffill(log, "phase_reuse_similar_training_target_enabled", i, None),
            "phase_reuse_similar_training_target": _log_get_ffill(log, "phase_reuse_similar_training_target", i, None),
            "phase_reuse_similar_transfer_weight_mean": _log_get_ffill(log, "phase_reuse_similar_transfer_weight_mean", i, None),
            "phase_reuse_similar_transfer_weight_min": _log_get_ffill(log, "phase_reuse_similar_transfer_weight_min", i, None),
            "phase_reuse_similar_transfer_weight_max": _log_get_ffill(log, "phase_reuse_similar_transfer_weight_max", i, None),
            "phase_reuse_weighted_effective_samples": _log_get_ffill(log, "phase_reuse_weighted_effective_samples", i, None),
            "phase_reference_reuse_mode": _log_get_ffill(log, "phase_reference_reuse_mode", i, None),
            "phase_reference_candidate_signature": _log_get_ffill(log, "phase_reference_candidate_signature", i, None),
            "history_target_reference_id": _log_get_ffill(log, "history_target_reference_id", i, None),
            "history_reference_mismatch_count": _log_get_ffill(log, "history_reference_mismatch_count", i, None),
            "history_relabelled_count": _log_get_ffill(log, "history_relabelled_count", i, None),
            "history_relabel_delta_mean": _log_get_ffill(log, "history_relabel_delta_mean", i, None),
            "history_relabel_delta_max_abs": _log_get_ffill(log, "history_relabel_delta_max_abs", i, None),
            "phase_reference_probe_used": _log_get_safe(log, "phase_reference_probe_used", i, 0),
            "phase_reference_probe_phase_id": _log_get_safe(log, "phase_reference_probe_phase_id", i, None),
            "phase_reference_probe_phase_name": _log_get_safe(log, "phase_reference_probe_phase_name", i, None),
            "phase_reference_probe_phase_iter": _log_get_safe(log, "phase_reference_probe_phase_iter", i, None),
            "phase_reference_probe_source": _log_get_safe(log, "phase_reference_probe_source", i, None),
            "phase_reference_probe_target_signature": _log_get_safe(log, "phase_reference_probe_target_signature", i, None),
            "phase_reference_probe_candidate_signature": _log_get_safe(log, "phase_reference_probe_candidate_signature", i, None),
            ...
            "actual_beta_used": _log_get_ffill(log, "actual_beta_used", i, None),
            ...
            "adaptive_phase_relation": _log_get_ffill(log, "adaptive_phase_relation", i, None),
            "adaptive_sample_target": _log_get_ffill(log, "adaptive_sample_target", i, None),
            ...
            "adaptive_forced_reexplore_need": _log_get_ffill(log, "adaptive_forced_reexplore_need", i, None),
            ...
            "transfer_noise_enabled": _log_get_ffill(log, "transfer_noise_enabled", i, None),
            "transfer_noise_learn_base": _log_get_ffill(log, "transfer_noise_learn_base", i, None),
            "transfer_noise_mode": _log_get_ffill(log, "transfer_noise_mode", i, None),
            "transfer_weight_mean": _log_get_ffill(log, "transfer_weight_mean", i, None),
            "transfer_weight_min": _log_get_ffill(log, "transfer_weight_min", i, None),
            "transfer_weight_max": _log_get_ffill(log, "transfer_weight_max", i, None),
            "transfer_extra_noise_std_mean": _log_get_ffill(log, "transfer_extra_noise_std_mean", i, None),
            "transfer_extra_noise_std_max": _log_get_ffill(log, "transfer_extra_noise_std_max", i, None),
            "transfer_learned_base_noise_var": _log_get_ffill(log, "transfer_learned_base_noise_var", i, None),
            "transfer_learned_base_noise_std": _log_get_ffill(log, "transfer_learned_base_noise_std", i, None),
            "transfer_noise_std_mean": _log_get_ffill(log, "transfer_noise_std_mean", i, None),
            "transfer_noise_std_max": _log_get_ffill(log, "transfer_noise_std_max", i, None),
            ...
            "residual_trigger_surprise": _log_get_ffill(log, "residual_trigger_surprise", i, None),
            "residual_trigger_surprise_source": _log_get_ffill(log, "residual_trigger_surprise_source", i, None),
