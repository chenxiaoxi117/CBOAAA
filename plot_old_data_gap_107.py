...
OUT = Path(r"C:\Users\POPchen\Desktop\duiibi_old_gap_107")
...
def main():
    ...
    for metric in ["cost", "delay", "energy"]:
        ...
        plot_value_curve(
            ...
            title=f"Old data | overall rolling{ROLLING} {metric}",
        )
        ...
        plot_gap_curve(
            ...
            title=f"Old data | overall rolling{ROLLING} {metric} gap vs Fixed-mid",
        )
        ...
        for lam in sorted(raw["lambda"].dropna().unique()):
            ...
            plot_gap_curve(
                ...
                title=f"Old data | lambda={lam} | rolling{ROLLING} {metric} gap vs Fixed-mid",
            )
        ...
        for tg in sorted(raw["task_group"].dropna().unique()):
            ...
            plot_gap_curve(
                ...
                title=f"Old data | {tg} | rolling{ROLLING} {metric} gap vs Fixed-mid",
            )
    ...
    # Excel 汇总
    xlsx = OUT / "old_data_gap_107_report.xlsx"
