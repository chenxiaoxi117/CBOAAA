...
$OUT  = "D:\CBOv2\results\window240_nogrowth_top5_static_bo_cbo_v5"
...
Write-Host "============================================================"
Write-Host "Start BO+CBO top5 rerun | window240 + nogrowth v5"
...
Write-Host ""
Write-Host "============================================================"
Write-Host "All BO+CBO tests finished."
