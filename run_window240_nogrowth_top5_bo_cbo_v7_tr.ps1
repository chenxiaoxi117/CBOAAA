...
$OUT  = 'D:\CBOv2\results\window240_nogrowth_top5_static_bo_cbo_v7_tr'
...
Write-Host '============================================================'
Write-Host 'Start BO+CBO top5 rerun | window240 + nogrowth v7 + CBO-first reference + adaptive TR'
Write-Host "ROOT = $ROOT"
Write-Host "OUT  = $OUT"
Write-Host "KEY  = $KEY"
Write-Host 'TR   = adaptive, radius 0.10 [0.04, 0.35], anchor posterior_mean, update best_so_far'
Write-Host '============================================================'
...
Write-Host ''
Write-Host '============================================================'
Write-Host 'All BO+CBO v7 TR tests finished.'
