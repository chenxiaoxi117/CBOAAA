...
$OUT = 'D:\CBOv2\results\window240_nogrowth_top5_static_bo_cbo_v8_fixed5_multiseed'
...
Write-Host '============================================================'
Write-Host 'Start BO+CBO top5 multiseed rerun | window240 + nogrowth v8 + fixed5 shared probes + no TR'
...
Write-Host ''
Write-Host '============================================================'
Write-Host 'All BO+CBO v8 fixed5 multiseed tests finished.'
