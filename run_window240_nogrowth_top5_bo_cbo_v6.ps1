...
$OUT  = 'D:\CBOv2\results\window240_nogrowth_top5_static_bo_cbo_v6'
...
Write-Host '============================================================'
Write-Host 'Start BO+CBO top5 rerun | window240 + nogrowth v6 + CBO-first reference'
...
Write-Host ''
Write-Host '============================================================'
Write-Host 'All BO+CBO v6 tests finished.'
